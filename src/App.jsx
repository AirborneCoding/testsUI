    ...
    <>
      ...
      <div className='body-container my-16'>
        ...
        <div className="mt-5 grid gap-10">
          ...
          {/* SECOND SECTION */}
          <section className="flex flex-col md:flex-row md:space-x-5 space-y-5 md:space-y-0">

            {/* chart */}
            <div className="border border-spacing-1 rounded-md shadow-lg md:w-3/4">
              <Chart4 />
            </div>

            {/* the analyse div */}
            <div className="border border-spacing-1 rounded-md shadow-lg md:w-1/4 px-3 py-2 bg-gradient-to-b from-white via-white to-purple-100">
              <div className='mb-4'>
              ...
              <div className="flex justify-end mt-44">
                <button className='flex items-center  p-1 border border-cyan-100'>
                  <WiStars className='text-yellow-500 font-bold' size={25} />
                  Analyse
                </button>
              </div>
